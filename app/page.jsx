      ...
      <section id="about">
        <div className="container mx-auto px-4 md:px-6 text-center pb-10">
          ...
          <ul className=" list-disc pl-5 mx-auto mt-3 max-w-[1000px] text-gray-500 md:text-l/relaxed text-left">
            ...
            <li>
               <strong>Academia. We organize Foreign Language Courses,</strong> Workshops and Industry Talks
            </li>
            <li>
              <strong>Support you!</strong> SAB guides students in matters such scholarships, internships and exchange programs
            </li>
          </ul>
        </div>
      </section>
      ...
      <section id="events" className="py-20">
        <div className="container mx-auto px-4 md:px-6 text-center pb-10">
          ...
          <p className="mx-auto mt-3 max-w-[900px] text-gray-500 md:text-l/relaxed">
            ...
            innovation, and to help newcomers adjust and progress in the
            institute.
          </p>
